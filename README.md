...
# ИЗВЕСТНЫЕ ПРОБЛЕМЫ ДЛЯ ЯНДЕКС.ИГРЫ, ОБНАРУЖЕННОЙ 02.11.2024
Когда вы запускаете некоторые игры, например, «Ёжики» от RedSpell на Ungoogled-Chromium, кнопка «поделиться» перестаёт работать, что делает невозможным добавить к меню. Пользователь BK782_User будет разбираться в этой проблеме. Если вы нашли обходной путь, пожалуйста, не стесняйтесь сообщить нам в разделе Issues.
